...
public class LoginActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (db.isReady()) {
            ...
            String linkedTopic = UiUtils.parseNightVexInviteUri(getIntent().getDataString());
            Intent intent = !TextUtils.isEmpty(linkedTopic) ?
                    new Intent(this, MessageActivity.class).putExtra(Const.INTENT_EXTRA_TOPIC, linkedTopic) :
                    new Intent(this, ChatsActivity.class);
