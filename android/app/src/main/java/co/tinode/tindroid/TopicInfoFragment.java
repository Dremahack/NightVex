...
public class TopicInfoFragment extends Fragment implements MenuProvider, MessageActivity.DataSetChangeListener {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstance) {
        ...
        view.findViewById(R.id.displayQRCode).setOnClickListener(v -> {
            ...
            String inviteUri = mTopic.isGrpType() ?
                    UiUtils.makeGroupInviteUri(mTopic.getName()) :
                    UiUtils.makeProfileInviteUri(mTopic.getName());
            UiUtils.generateQRCode(qrCodeImageView, inviteUri);
            builder.setView(codeView).setTitle(mTopic.isGrpType() ?
                    R.string.group_invite_qr : R.string.my_qr_code);
            builder
