...
public class TindroidApp extends Application implements DefaultLifecycleObserver {
    ...
    // Used mostly for convenience to use correct server address i.e. 10.0.2.2:6060 vs production and
    ...
    public void onCreate() {
        ...
        try {
            ...
            Log.w(TAG, "Firebase Crashlytics not configured; crash reporting disabled.");
        }
    ...
    public void onStart(@NonNull LifecycleOwner owner) {
        ...
        // If yes, get the NightVex client config.
