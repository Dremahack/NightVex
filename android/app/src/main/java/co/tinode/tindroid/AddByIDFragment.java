...
public class AddByIDFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        UiUtils.generateQRCode(qrCodeImageView, UiUtils.makeProfileInviteUri(myID));
        ...
        scanCodeButton.setOnClickListener(button -> {
            ...
            if (mQrScanner == null) {
                mQrScanner = new QRCodeScanner(activity, null, this::goToScannedTopic);
            }
    ...
    private void goToScannedTopic(String rawValue) {
        String id = UiUtils.parseNightVexInviteUri(rawValue);
        if (TextUtils.isEmpty(id)) {
            Toast.makeText(requireActivity(), R.string.qr_code_invalid, Toast.LENGTH_SHORT).show();
            return;
        }
        goToTopic(id);
    }
