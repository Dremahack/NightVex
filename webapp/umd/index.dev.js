...
const APP_NAME = 'NightVexWeb/' + (_version_js__WEBPACK_IMPORTED_MODULE_0__.PACKAGE_VERSION || '0.25');
const API_KEY = 'AQEAAAABAAD_rAp4DJh05a1HAwFT3A6K';
const KNOWN_HOSTS = {
  hosted: 'vshp-project.ru',
  local: 'localhost:6060'
};
const DEFAULT_HOST = window.location.host || KNOWN_HOSTS.hosted;
...
const LINK_CONTACT_US = 'mailto:support@vshp-project.ru';
const LINK_PRIVACY_POLICY = 'https://vshp-project.ru/privacy.html';
const LINK_TERMS_OF_SERVICE = 'https://vshp-project.ru/terms.html';
...
function updateFavicon(count) {
  ...
  document.title = (count > 0 ? '(' + count + ') ' : '') + 'NightVex';
}
...
/* harmony export */ });
const PACKAGE_VERSION = "0.25.2-nightvex.2";
...
class TinodeWeb extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  getBlankState() {
    ...
    return {
      ...
      desktopAlertsEnabled: ((0,_lib_host_name_js__WEBPACK_IMPORTED_MODULE_14__.isSecureConnection)() || (0,_lib_host_name_js__WEBPACK_IMPORTED_MODULE_14__.isLocalHost)()) && typeof firebase_app__WEBPACK_IMPORTED_MODULE_2__.initializeApp != 'undefined' && typeof navigator != 'undefined' && typeof FIREBASE_INIT != 'undefined' && !!FIREBASE_INIT && !!FIREBASE_INIT.messagingVapidKey,
    ...
    if (this.props.avatar === true) {
      if (tinode_sdk__WEBPACK_IMPORTED_MODULE_1__.Tinode.isSelfTopicName(this.props.topic)) {
        ...
        if (!isGroup) {
          ...
          avatar = react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
            className: className
          }, "group");
        }
      }
