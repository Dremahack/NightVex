...
export const APP_NAME = 'NightVexWeb/' + (PACKAGE_VERSION || '0.25');

// API key. Use https://github.com/tinode/chat/tree/master/keygen to generate your own
export const API_KEY = 'AQEAAAABAAD_rAp4DJh05a1HAwFT3A6K';

// The array of possible hosts to connect to.
export const KNOWN_HOSTS = {hosted: 'vshp-project.ru', local: 'localhost:6060'};

// Default host name and port to connect to.
export const DEFAULT_HOST = window.location.host || KNOWN_HOSTS.hosted;
...
// Link for "Contact Us".
export const LINK_CONTACT_US = 'mailto:support@vshp-project.ru';

// Link to Privacy Policy.
export const LINK_PRIVACY_POLICY = 'https://vshp-project.ru/privacy.html';

// Link to Terms of Service.
export const LINK_TERMS_OF_SERVICE = 'https://vshp-project.ru/terms.html';
